...
<body>
    ...
    <script>
      ...
      <%
            ...
            String prereqQuery = "SELECT courseID, prerequisiteID FROM prerequisites";
            ps = con.prepareStatement(prereqQuery);
            rs = ps.executeQuery();
            while (rs.next()) {
                String courseID = rs.getString("courseID");
      ...
      %>
                ...
                graph.addEdge("<%= courseID %>", "<%= prerequisiteID %>", { size: 5, color: "purple" });
      <%
            }
