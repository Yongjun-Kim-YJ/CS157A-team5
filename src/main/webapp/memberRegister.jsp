    ...
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        ...
        <form method="post" id="login-form" action="Login" class="space-y-4">
            <div>
                ...
                <input type="text" id="login-username" name="login-username" placeholder="Enter your username" required class="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
            </div>
            <div>
        ...
        <form action="Register" method="post" id="register-form" class="hidden space-y-4">
            <div>
                ...
                <input type="text" id="username" name="username" placeholder="Enter username" required class="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
            </div>
            <div>
